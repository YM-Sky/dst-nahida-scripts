...
local FISH_DEFS =
{
	...
	oceanfish_small_6 = { -- autumn
		...
		lures = { hook = 0.25, special = 1.00, rot = 1.00, seed = 1.50, berry = 1.50, spoon = 0.00, spinnerbait = 0.00, insect = 0.00,
        dst_gi_nahida = 2.00 },
		diet = DIET.VEGGIE,
		cooker_ingredient_value = COOKER_INGREDIENT_SMALL,
	...
	oceanfish_small_8 = { -- summer
		...
		lures = { hook = 0.25, special = 1.00, rot = 1.00, seed = 0.00, berry = 0.00, spoon = 1.00, spinnerbait = 0.00, insect = 1.00,
        dst_gi_nahida =2.00 },
		diet = DIET.MEAT,
		cooker_ingredient_value = COOKER_INGREDIENT_SMALL,
		edible_values = EDIBLE_VALUES_SMALL_MEAT,
	...
	oceanfish_medium_2 = {
		...
		lures = { hook = 0.25, special = 1.00, rot = 0.50, seed = 0.00, berry = 0.00, spoon = 1.00, spinnerbait = 1.00, insect = 1.00,
        dst_gi_nahida = 1.50 },
		diet = DIET.MEAT,
		cooker_ingredient_value = COOKER_INGREDIENT_MEDIUM,
		edible_values = EDIBLE_VALUES_MEDIUM_MEAT,
	...
	oceanfish_medium_8 = { -- winter fish
		...
		lures = { hook = 0.25, special = 1.00, rot = 0.50, seed = 0.25, berry = 1.00, spoon = 1.00, spinnerbait = 1.00, insect = 1.00,
        dst_gi_nahida = 2.00 },
		diet = DIET.OMNI,
...
for k, v in pairs(FISH_DEFS) do
    if v.lures ~= nil and v.lures.dst_gi_nahida == nil then
        v.lures.dst_gi_nahida = 0.50
    end
end
