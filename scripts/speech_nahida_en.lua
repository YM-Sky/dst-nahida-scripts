...
return{
	...
	ACTIONFAIL =
	{
        ...
        {
            ITEMMIMIC = "I knew it.",
            NAHIDA_ITEM_SLOT_POSITION_MSG = "Can only be used in compartments 1-3 in the item colu",
        },
...
--fallback to speech_wilson.lua 		TASTY = "only_used_by_warly",
	...
	ANNOUNCE_HUNGRY = "Even gods get hungry, you know~。",
...
--fallback to speech_wilson.lua     ANNOUNCE_WORMHOLE_SAMESPOT = "only_used_by_winona",
	...
	ANNOUNCE_WASHED_ASHORE = "I got drenched from head to toe.",
