...
local function MakePreparedFood(data)
    ...
    local function fn()
        ...
        if spicename ~= nil then
            ...
            inst.AnimState:SetBuild(data.overridebuild or (data.basename or data.name))
            inst.AnimState:SetBank(data.basename or data.name)
        end

        inst.AnimState:PlayAnimation("idle")
        if data.scale and data.scale.x and data.scale.y and data.scale.z then
        ...
        inst.AnimState:OverrideSymbol("swap_food", data.overridebuild, data.basename or data.name)
        --inst.food_symbol_build = data.overridebuild
...
local data_dishes = require("core_dst_gi_nahida/data/dishes")
