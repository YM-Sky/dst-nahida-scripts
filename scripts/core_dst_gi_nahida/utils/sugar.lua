...
function tool:checkMODEnabledByFolderName(folder_name)
    if TUNING.MOD_DST_GI_NAHIDA.MOD_LIST and TUNING.MOD_DST_GI_NAHIDA.MOD_LIST.map_dirname then
        if TUNING.MOD_DST_GI_NAHIDA.MOD_LIST.map_dirname[folder_name] then
            return true
        end
    end
    return false
...
function tool:checkMODEnabledByModInfoName(modinfo_name)
    if TUNING.MOD_DST_GI_NAHIDA.MOD_LIST and TUNING.MOD_DST_GI_NAHIDA.MOD_LIST.map_modinfoname then
        for _,name in ipairs(TUNING.MOD_DST_GI_NAHIDA.MOD_LIST.map_modinfoname) do
...
function tool:getModConfigDataFromTUNING(op_suffix)
    return TUNING[string.upper('CONFIG_DST_GI_NAHIDA'..op_suffix)]
end
